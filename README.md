...
<button onclick="window.location.href='https://cbozeyboy199.github.io/chat-place/'">chat</button>
 <button type="button" onclick="alert('copy this link and youre in the chat cbozeyboy199.github.io/chat/')">fix chat</button>  
